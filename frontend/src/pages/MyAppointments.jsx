...
//         const dateArray = slotDate.split('_'); // Splitting date into parts
//         const monthIndex = Number(dateArray[1]) - 1; // Subtract 1 for zero-based indexing
...
const MyAppointments = () => {
    ...
    const [paymentDetails, setPaymentDetails] = useState({ accountNumber: '', amount: '' });
